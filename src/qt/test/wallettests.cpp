// Copyright (c) 2015-2022 The Waifu Core developers
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<WaifuAmountField*>("payAmount")->setValue(amount);
...
void CompareBalance(WalletModel& walletModel, CAmount expected_balance, QLabel* balance_label_to_check)
{
    ...
    QString balanceComparison = WaifuUnits::formatWithUnit(unit, expected_balance, false, WaifuUnits::SeparatorStyle::ALWAYS);
...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_bitnet-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_bitnet-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_bitnet-qt  # macOS
void TestGUI(interfaces::Node& node)
{
    ...
    // Amount input
    WaifuAmountField* amountInput = receiveCoinsDialog.findChild<WaifuAmountField*>("reqAmount");
