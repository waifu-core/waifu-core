...
//! Entry point for WaifuApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &WaifuApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for WaifuGUI tests.
void AppTests::guiTests(WaifuGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &WaifuGUI::consoleShown, this, &AppTests::consoleTests);
