...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, WaifuUnits::SeparatorStyle separators=WaifuUnits::SeparatorStyle::STANDARD) const;
