...
/** Main Waifu application object */
class WaifuApplication: public QApplication
{
    Q_OBJECT
public:
    explicit WaifuApplication();
    ~WaifuApplication();
    ...
    /// Get window identifier of QMainWindow (WaifuGUI)
...
Q_SIGNALS:
    ...
    void windowShown(WaifuGUI* window);
