...
const char* pszTimestamp = "Waifu Core released for Anime fans and Waifu fans!";
    const CScript genesisOutputScript = CScript() << ParseHex("04ec641559759336db46648cfe1cd574d6cd414bea722541cd9edd14371187ebf662987da02b518d583eda8d417ad8dede03663e39a3ac4164af426d315eec72f7") << OP_CHECKSIG;
...
//        consensus.nSubsidyHalvingInterval = 210000;
      ...
      //  consensus.switchAlgoHeight = std::numeric_limits<int>::max();
        consensus.switchAlgoHeight = 1;    // activate aurum @ 125,000 height
...
public:
    CTestNetParams() {
        ...
        consensus.BIP34Height = 0;
        consensus.BIP34Hash = uint256S("0x0000857c81e5afd3c38b8373a81ab270cc7f7ea19510803f2478a5b65331fc10");
     ...
     consensus.BIP65Height = 581885; // 00000000007f6655f22f98e72ed80d8b06dc761d5da09df0fa1dc4be4f861eb6
        ...
        genesis = CreateGenesisBlock(1296688602, 184942, 0x1f00ffff, 1, 50 * COIN);


 consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000857c81e5afd3c38b8373a81ab270cc7f7ea19510803f2478a5b65331fc10"));
        assert(genesis.hashMerkleRoot == uint256S("0x2f9e5e74139bdeaa8cd6ed1fff06d794b845f49e6af70356500d1e408c9a3711"));
...
public:
    explicit SigNetParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1598918400, 1578426, 0x1e0377ae, 1, 50 * COIN);


consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000027dc0229ef17f16a256e683b7f93fefef99612a878969e72ab0dbd30c94"));
        assert(genesis.hashMerkleRoot == uint256S("0x2f9e5e74139bdeaa8cd6ed1fff06d794b845f49e6af70356500d1e408c9a3711"));
...
//        consensus.hashGenesisBlock = genesis.GetHash();
  ...
  consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x505b72f16a86ac061dac6ccf82b6699ab181aaf793ea9d667e5da6c7f2dcf4d5"));
        assert(genesis.hashMerkleRoot == uint256S("0x2f9e5e74139bdeaa8cd6ed1fff06d794b845f49e6af70356500d1e408c9a3711"));
