...
/* A AEAD class for ChaCha20-Poly1305@waifu.
 *
 ...
 *
 * The chacha20-poly1305@waifu combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@waifu cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@waifu are relatively fast in
