// Copyright (c) 2019-2021 The Waifu Core developers
...
/* A AEAD class for ChaCha20-Poly1305@bitnet.
 *
 ...
 *
 * The chacha20-poly1305@bitnet combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bitnet cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bitnet are relatively fast in
