# User-space, Statically Defined Tracing (USDT) for Waifu Core

Waifu Core includes statically defined tracepoints to allow for more
...
**Note**: Waifu Core uses temporary clones of the _main_ UTXO cache
...
## Adding tracepoints to Waifu Core
...
The `readelf` tool can be used to display the USDT tracepoints in Waifu Core.
