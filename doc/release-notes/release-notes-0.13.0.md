Waifu Core version 0.13.0 is now available from:
  ...
  <https://waifu.org/bin/waifu-core-0.13.0/>
...
- Adding `dbcache=100` in waifu.conf
...
For example:
    ...
    $ src/waifu-cli -stdin walletpassphrase
    mysecretcode
    120
...
compatible peers.
[BIP 152](https://github.com/waifu/bips/blob/master/bip-0152.mediawiki)
...
[Pull request](https://github.com/waifu/waifu/pull/8035/files), [BIP 32](https://github.com/waifu/bips/blob/master/bip-0032.mediawiki)
...
141](https://github.com/waifu/bips/blob/master/bip-0141.mediawiki), [BIP
143](https://github.com/waifu/bips/blob/master/bip-0143.mediawiki), [BIP
144](https://github.com/waifu/bips/blob/master/bip-0144.mediawiki), and [BIP
145](https://github.com/waifu/bips/blob/master/bip-0145.mediawiki) are
...
Witness)] (https://github.com/waifu/bips/blob/master/bip-0141.mediawiki).
...
(https://github.com/waifu/bips/blob/master/bip-0141.mediawiki) for additional
details.)
...
- The optional new p2p message "feefilter" is implemented and the protocol
  ...
  feerate. [BIP 133](https://github.com/waifu/bips/blob/master/bip-0133.mediawiki)
...
65](https://github.com/waifu/bips/blob/master/bip-0065.mediawiki)

  - OP_NOP3 has been renamed to OP_CHECKSEQUENCEVERIFY by [BIP 
112](https://github.com/waifu/bips/blob/master/bip-0112.mediawiki)
...
- Each ZMQ notification now contains an up-counting sequence number that allows
  ...
  PR [#7762](https://github.com/waifu/waifu/pull/7762).
...
- #7550 `8b958ab` Input-from-stdin mode for waifu-cli (laanwj)
...
- #7613 `3798e5d` Add autocomplete to waifu-qt's console window (GamerSg)
...
- #7636 `fb0ac48` Add waifu address label to request payment QR code (makevoid)
- #8231 `760a6c7` Fix a bug where the SplashScreen will not be hidden during startup (jonasschnelli)
- #8256 `af2421c` BUG: waifu-qt crash (fsb4000)
- #8257 `ff03c50` Do not ask a UI question from waifud (sipa)
...
- #8047 `37f9a1f` Test_framework: Set wait-timeout for waifud procs (MarcoFalke)
...
- #7744 `d8e862a` test_framework: detect failure of waifud startup (laanwj)
...
- #7975 `fc23fee` Update waifu-core GitHub links (MarcoFalke)
