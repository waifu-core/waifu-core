Waifu Core version 0.11.0 is now available from:
  ...
  <https://waifu.org/bin/waifu-core-0.11.0/>
...
For example, add the following to `waifu.conf`:
...
related to the blockchain in the waifu system: the raw blocks as received over 
...
For an example script see [waifu-submittx](https://github.com/laanwj/waifu-submittx).
...
- #5334 `cf87536` libwaifuconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new waifu-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add waifu logo to about screen
...
- #5809 `46bfbe7` Add waifu-cli man page
...
- #5849 `41259ca` contrib/init/waifud.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for waifu-tx)
