Waifu Core version 0.16.1 is now available from:
  ...
  <https://waifucore.org/bin/waifu-core-0.16.1/>
...
- #12843 `df38b13` Test starting waifud with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure waifud processes are cleaned up when tests end (sdaftuar)
