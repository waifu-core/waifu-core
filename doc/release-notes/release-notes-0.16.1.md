Waifu Core version 0.16.1 is now available from:

  <https://bitnetcore.org/bin/bitnet-core-0.16.1/>
...
- #12843 `df38b13` Test starting bitnetd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bitnetd processes are cleaned up when tests end (sdaftuar)
