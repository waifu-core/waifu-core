Waifu Core version *0.15.2* is now available from:

  <https://bitnetcore.org/bin/bitnet-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in bitnet-tx (TheBlueMatt)
