...
Waifu Core version 0.19.1 is now available from:

  <https://waifucore.org/bin/waifu-core-0.19.1/>
...
From Waifu Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Waifu Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Waifu Core does not yet change appearance when
...
- #17488 fix "waifud already running" warnings on macOS (fanquake)
