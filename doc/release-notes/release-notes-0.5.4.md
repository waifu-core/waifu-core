...
Fix Waifu-Qt notifications under Growl 1.3.
Increase required age of Waifu-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxWaifu properly when installing Waifu-Qt over it. (Windows)
