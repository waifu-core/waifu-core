Waifu Core version 0.13.2 is now available from:
  ...
  <https://waifu.org/bin/waifu-core-0.13.2/>
...
- #8908 `4a974b2` Update waifu-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow waifu-tx to create v2 transactions (btcdrak)
