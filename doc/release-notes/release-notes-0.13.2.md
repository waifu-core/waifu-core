Waifu Core version 0.13.2 is now available from:

  <https://bitnet.org/bin/bitnet-core-0.13.2/>
...
- #8908 `4a974b2` Update bitnet-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitnet-tx to create v2 transactions (btcdrak)
