Waifu Core version 0.10.4 is now available from:

  <https://bitnet.org/bin/bitnet-core-0.10.4/>
...
- #6953 `43c2789` Split bitnet-tx into its own package
- #6953 `dfe0d4d` Include bitnet-tx binary on Debian/Ubuntu
