...
- bitnet-core/gui#21 Improve pruning tooltip (fluffypony, WaifuErrorLog)
...
- bitnet/bitnet#20577 libconsensus: add missing error code description, fix NWaifu link (theStack)
