...
This document provides guidelines for internationalization of the Waifu Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitnet_en.ts` remains unchanged.
