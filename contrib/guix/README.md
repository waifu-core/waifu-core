...
This directory contains the files necessary to perform bootstrappable Waifu
Core builds.
...
To build Waifu Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Waifu Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/bitnet-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/bitnet-core/guix.sigs).
