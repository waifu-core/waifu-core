#!/usr/bin/env python3
# Copyright (c) 2016-2022 The Waifu Core developers
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Waifu Core developers'
...
CPP_HEADER = '''
// Copyright (c) %s The Waifu Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
'''
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by The Waifu Core developers'
                 % (filename))
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Waifu
