...
complete --command waifud --no-files

# Extract options
function __fish_waifud_get_options
...
complete \
    --command waifud \
    --arguments "(__fish_waifud_get_options --nofiles)"
