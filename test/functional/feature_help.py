...
"""Verify that starting waifu with -h works as expected."""
...
class HelpTest(WaifuTestFramework):
    ...
    def run_test(self):
        self.log.info("Start waifu with -h for help text")
        ...
        self.log.info("Start waifu with -version for version information")
        ...
        self.log.info("Start waifud with -fakearg to make sure it does not start")
