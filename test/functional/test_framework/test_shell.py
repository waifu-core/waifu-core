...
class TestShell:
    """Wrapper Class for WaifuTestFramework.

    The TestShell class extends the WaifuTestFramework
    ...
    class __TestShell(WaifuTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by WaifuTestFramework child class.
            self.num_nodes = 1
