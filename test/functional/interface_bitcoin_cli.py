...
class TestWaifuCli(WaifuTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `waifu-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and waifu-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and waifu-cli getwalletinfo return expected wallet info")
            ...
            # Test waifu-cli -generate with -rpcwallet in multiwallet mode.
