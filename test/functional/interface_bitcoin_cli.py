...
class TestWaifuCli(WaifuTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `bitnet-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and bitnet-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and bitnet-cli getwalletinfo return expected wallet info")
            ...
            # Test bitnet-cli -generate with -rpcwallet in multiwallet mode.
