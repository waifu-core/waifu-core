...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the WaifuTestFramework
    pass


class ExampleTest(WaifuTestFramework):
    # Each functional test is a subclass of the WaifuTestFramework class.
    ...
    def custom_method(self):
        ...
        WaifuTestFramework class so other tests can use it."""
