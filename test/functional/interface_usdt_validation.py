#!/usr/bin/env python3
# Copyright (c) 2022 The Waifu Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.

""" Tests the validation:* tracepoint API interface.
    See https://github.com/bitnet/bitnet/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(WaifuTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/bitnet/bitnet/blob/master/doc/tracing.md#tracepoint-validationblock_connected
