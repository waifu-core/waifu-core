...
Verify that a bitnetd node can use an external signer command.
...
class RPCSignerTest(WaifuTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart bitnetd with -signer=<cmd>',
