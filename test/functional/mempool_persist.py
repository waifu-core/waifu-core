...
By default, waifud will dump mempool on shutdown and
...
class MempoolPersistTest(WaifuTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent waifud from writing mempool.dat to disk. Verify that `savemempool` fails")
